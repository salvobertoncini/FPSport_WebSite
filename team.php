...
<div id="wrapper">
    ...
    <![endif]--> 
        ...
        <div id="content">
            ...
            <table class="table" width="100%" height="100%" border="1">  
                 <tr> 
                  <td> <img src= "img/nondisponibile.jpg" width="180px" height="271px"></td>
                  <td> 
                        <table class="table" width="100%" heigtht="100%" border="1" valign="top">
                         <tr> 
                          <td>#10</td>
                         </tr>
                         <tr>
                          <td>Claudio Cavalieri</td>
                         </tr>
                         <tr>
                          <td>Guardia </td>
                         </tr> 
